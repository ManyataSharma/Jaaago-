...
const HomePage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#fdfaf6]">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-[#FFF5E4] to-[#fdfaf6] py-20 px-4">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="flex justify-center">
              <div className="w-64 h-64 bg-[#FFF5E4] rounded-full flex items-center justify-center">
                <Building className="w-32 h-32 text-[#FFA559]" />
              </div>
            </div>
          </div>
        </div>
      ...
      {/* How It Works */}
      <section className="py-16 px-4 bg-[#FFF5E4]">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-[#FFF5E4] rounded-lg p-6">
              ...
              <div className="bg-gray-200 h-48 rounded-lg mb-4 flex items-center justify-center">
                <p className="text-gray-500">Pothole on Main Road</p>
              </div>
              <p className="text-[#666666]">
            ...
            <div className="bg-[#C9F4AA] rounded-lg p-6">
              ...
              <div className="bg-gray-200 h-48 rounded-lg mb-4 flex items-center justify-center">
                <p className="text-gray-500">Road Repaired Successfully</p>
              </div>
              <p className="text-[#666666]">
      ...
      {/* App Download */}
      <section className="py-16 px-4 bg-[#333333] text-white">
